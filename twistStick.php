...
<html>
    ...
    <body>
        ...
        ?>
            ...
            $userID = "";
                echo '<a href="flowers_twistStick.php?user_id='.$userID.'" class="back1">Back</a>'
                        ?>
    ...
    <span class='rating1'>Click here <a class='review' href='newReview2.php'><b>[Review]</b></a> to see our reviews.</span>
                        ...
                        <div class="btn-groups">
                            <?php
                               ...
                               printf("<form action='pants.php?user_id=%s&id=%d' method='POST'>", $user_id, $pID);
