...
<html>
    ...
    <body>
        ...
        <nav class="header_title">
            <div><a href="admin-homepage.php" class="header_logo">Flower Paradise</a></div>
            <div><img src="image/TPLogo.jpg" class="imageLogo"/></div>
            ...
            <ul class="header_ul">
                ...
                <div class="dropdown-content">
                <a href="admin_page.php" class="admin_a">Add Product</a>
                <a href="list_product.php" class="admin_a">List of Product</a>
                </div>
                </div>
               
                <li class="header_li"><a href="generate-promotion.php" class="header_a">Add Promotion</a></li>
