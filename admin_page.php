        ...
        <div class="container">
            <div class="admin-product-form-container">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form_title">Enter Product Categories:</div>
                    <input type="text" placeholder="Enter Product Categories" name="product_categories" class="box" value="<?php
                    echo (isset($categories))? $categories : "";
                    ?>" />
                    <div class="form_title">Enter Product Name:</div>
                    <input type="text" placeholder="Enter Product Name" name="product_name" class="box" value="<?php
                    echo (isset($name))? $name : "";
                    ?>" />
                    <div class="form_title">Enter Product Price:</div>
                    <input type="number" placeholder="Enter Product Price" name="product_price" min="1" class="box" value="<?php
                    echo (isset($price))? $price : "";
                    ?>" />
                    <div class="form_title">Enter Product Description:</div>
                    <input type="text" placeholder="Enter Product Description" name="product_description" class="box" value="<?php
                    echo (isset($description))? $description : "";
                    ?>" />
                    <div class="form_title">Enter Product Image:</div>
