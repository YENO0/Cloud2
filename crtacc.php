...
<html>
    <head>
        <meta charset="UTF-8">
        <title>WELCOME TO TREND PARADISE</title>
        ...
        <form class="suf" action="" method="POST">
            ...
            <div class="set">
                <div class="animationHeader">
                    <h1 style="text-align: center;"><div class="animationHeader"><span>S</span><span>I</span><span>G</span><span>N</span> <span>U</span><span>P</span> <span>A</span><span>S</span> <span>A</span> <span>T</span><span>R</span><span>E</span><span>N</span><span>D</span> <span>P</span><span>A</span><span>R</span><span>A</span><span>D</span><span>I</span><span>S</span><span>E</span> <span>M</span><span>E</span><span>M</span><span>B</span><span>E</span><span>R</span></div></h1>
                    <p style="text-align: center; font-size:18px;">Create your profile and get access to the Trend Paradise products</p>
                    <hr>
                    ...
                    <center>
                        ...
                        <label for="agree">By creating an account,you agree to Trend Paradise<a href="privacy.php"  class="pri">privacy policy</a></label>
                        <br/>
