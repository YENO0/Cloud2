...
$sql = "SELECT * FROM products WHERE categories = 'sunflower'";
if($result = $con->query($sql)){
                while($record = $result->fetch_object()){
                    ...
                    $userID = "";
                        ...
                        <tr class='tr1'>
                        <td class='td2'><center><a href='sunflower.php?id=%s&user_id=%s'><img src='uploaded_img/%s' height='350' alt='' class='product_img'></a></center></td>
                        </tr>
                        <tr class='tr1'>
                        <td class='td1'>%s<br/><br/>
                        <b style='font-size: 25px;'>RM %s.00</b>
                        <br/><br/><a href='sunflower.php?id=%s&user_id=%s' class='product1'>View More Details &#128073; </a></td>
                        <br/>
                        </tr>
                        </table>
