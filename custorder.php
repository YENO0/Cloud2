...
<html>
    ...
    <body style="background-image:url(image/background_1.jpg);
        ...
        echo "<center><h2>Welcome To Your Order Page!</h2></center>";
        echo "<div class='SearchBar' style='height:20px;'>";
        printf("<input type='text' name='search' placeholder='  Search' value='$search'>");
        echo "<button class='searchBtn' type='submit'><i class='fas fa-search'></i></button>";
        echo "</div>";
        echo "</form>";
        ?>
        <?php
